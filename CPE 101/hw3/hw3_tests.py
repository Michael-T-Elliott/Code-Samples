...
class TestCollisions(unittest.TestCase):
   def test_sphere_intersection0(self):
      ...
      self.assertEqual(s, so, 'Normal 0: Input sphere modified.')
      self.assertEqual(r, ro, 'Normal 0: Input ray modified.')
   ...
   def test_find_intersection_points0(self):
      ...
      self.assertEqual(spheres, sphereso, 'Normal 0: Input list modified.')
      self.assertEqual(r, ro, 'Normal 0: Input ray modified.')
   ...
   def test_sphere_normal0(self):
      s = Sphere(Point(0.0, 0.0, 0.0), 4.0)
      so = Sphere(Point(0.0, 0.0, 0.0), 4.0)
      p = Point(0.0, 0.0, 4.0)
      po = Point(0.0, 0.0, 4.0)
      sphere_normal_at_point(s, p)
      self.assertEqual(s, so, 'Normal 0: Input sphere modified.')
      self.assertEqual(p, po, 'Normal 0: Input point modified.')


   def test_sphere_normal1(self):
      s = Sphere(Point(0.0, 0.0, 0.0), 4.0)
      p = Point(0.0, 0.0, 4.0)
      self.assertEqual(sphere_normal_at_point(s, p), Point(0.0, 0.0, 1.0),
   ...
   def test_sphere_normal2(self):
      s = Sphere(Point(0.0, 0.0, 0.0), 4.0)
      p = Point(0.0, 4.0, 0.0)
      self.assertEqual(sphere_normal_at_point(s, p), Point(0.0, 1.0, 0.0),
         'Normal 2: Along y-axis for origin-centered sphere.')


   def test_sphere_normal3(self):
      s = Sphere(Point(0.0, 0.0, 0.0), 4.0)
      p = Point(0.47362624786864, 1.599239329218808, -3.635672117471643)

      self.assertEqual(sphere_normal_at_point(s, p),
         Point(0.118406561967, 0.399809832305, -0.908918029368),
