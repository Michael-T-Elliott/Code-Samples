...
class Finish:
   ...
   def __eq__(self, other):
      return epsilon_equal(self.ambient == other.ambient) and epsilon_equal(self.diffuse == other.diffuse)
...
class Sphere:
   ...
   def __eq__(self, other):
      return (self.center == other.center) and (self.ambient == other.ambient) and epsilon_equal(self.radius, other.radius) and (self.color == color)
